...
Path tag: echo_vector_atlas_b61a6/cinder_matrix_delta_bce8e/quartz_corridor_pulse_4655a/spec_relay_aurora_17387a.py
"""
...
DEFAULT_PROFILE: Dict[str, Any] = {
    "site": "OrbitLane",
    "surface": "web",
    "unit": "spec_relay_aurora_17387a",
    "mode": "sandbox"
}

class SpecRelayAurora17387a:
