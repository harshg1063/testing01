...
Path tag: echo_vector_atlas_b61a6/cinder_matrix_delta_bce8e/ember_vector_beacon_5595e/parcel_beacon_aurora_68f35f.py
"""
...
DEFAULT_PROFILE: Dict[str, Any] = {
    "site": "OrbitLane",
    "surface": "web",
    "unit": "parcel_beacon_aurora_68f35f",
    "mode": "sandbox"
}

class ParcelBeaconAurora68f35f:
