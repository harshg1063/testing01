...
Path tag: echo_vector_atlas_b61a6/cinder_matrix_delta_bce8e/ember_capsule_delta_68c42/ripple_corridor_relay_d3829/script_canvas_echo_ebc1eb.py
"""
...
DEFAULT_PROFILE: Dict[str, Any] = {
    "site": "OrbitLane",
    "surface": "web",
    "unit": "script_canvas_echo_ebc1eb",
    "mode": "sandbox"
}

class ScriptCanvasEchoEbc1eb:
