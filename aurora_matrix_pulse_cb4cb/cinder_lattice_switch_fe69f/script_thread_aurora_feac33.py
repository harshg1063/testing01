...
Path tag: aurora_matrix_pulse_cb4cb/cinder_lattice_switch_fe69f/script_thread_aurora_feac33.py
"""
...
DEFAULT_PROFILE: Dict[str, Any] = {
    "site": "OrbitLane",
    "surface": "web",
    "unit": "script_thread_aurora_feac33",
    "mode": "sandbox"
}

class ScriptThreadAuroraFeac33:
