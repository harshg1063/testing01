...
Path tag: aurora_matrix_pulse_cb4cb/velvet_lattice_relay_0db2d/nebula_lattice_switch_0f413/velvet_foundry_comet_bdd76/stream_canvas_aurora_75e4db.py
"""
...
DEFAULT_PROFILE: Dict[str, Any] = {
    "site": "OrbitLane",
    "surface": "web",
    "unit": "stream_canvas_aurora_75e4db",
    "mode": "sandbox"
}

class StreamCanvasAurora75e4db:
