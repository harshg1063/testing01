...
Path tag: aurora_matrix_pulse_cb4cb/velvet_lattice_relay_0db2d/nebula_lattice_switch_0f413/velvet_foundry_comet_bdd76/parcel_switch_cinder_58bcf8.py
"""
...
DEFAULT_PROFILE: Dict[str, Any] = {
    "site": "OrbitLane",
    "surface": "web",
    "unit": "parcel_switch_cinder_58bcf8",
    "mode": "sandbox"
}

class ParcelSwitchCinder58bcf8:
