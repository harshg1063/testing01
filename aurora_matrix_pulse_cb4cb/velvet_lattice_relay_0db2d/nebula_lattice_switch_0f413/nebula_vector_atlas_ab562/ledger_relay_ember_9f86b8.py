...
Path tag: aurora_matrix_pulse_cb4cb/velvet_lattice_relay_0db2d/nebula_lattice_switch_0f413/nebula_vector_atlas_ab562/ledger_relay_ember_9f86b8.py
"""
...
DEFAULT_PROFILE: Dict[str, Any] = {
    "site": "OrbitLane",
    "surface": "web",
    "unit": "ledger_relay_ember_9f86b8",
    "mode": "sandbox"
}

class LedgerRelayEmber9f86b8:
