...
Path tag: aurora_matrix_pulse_cb4cb/velvet_lattice_relay_0db2d/nebula_lattice_switch_0f413/nebula_vector_atlas_ab562/panel_comet_opal_daf9d5.py
"""
...
DEFAULT_PROFILE: Dict[str, Any] = {
    "site": "OrbitLane",
    "surface": "web",
    "unit": "panel_comet_opal_daf9d5",
    "mode": "sandbox"
}

class PanelCometOpalDaf9d5:
