...
Path tag: aurora_matrix_pulse_cb4cb/velvet_lattice_relay_0db2d/nebula_lattice_switch_0f413/nebula_vector_atlas_ab562/velvet_prism_delta_67b73/ledger_atlas_velvet_d1f5e1.py
"""
...
DEFAULT_PROFILE: Dict[str, Any] = {
    "site": "OrbitLane",
    "surface": "web",
    "unit": "ledger_atlas_velvet_d1f5e1",
    "mode": "sandbox"
}

class LedgerAtlasVelvetD1f5e1:
